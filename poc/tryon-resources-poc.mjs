...
const sources = [
  ...
  {
    id: "leffa",
    kind: "self-hosted-and-public-demo",
    name: "Leffa",
    url: "https://github.com/franciszzj/Leffa",
    license: "代码 MIT；Hugging Face 模型卡标注 MIT",
    use: "当前最清晰的免费自托管商业候选之一，支持上装、下装与连衣裙；仍须审查 SD/SDXL Inpainting 底座、DensePose/SCHP 等依赖与训练数据。",
    gate: "官方说明以 A100 为性能参考；公开 Space 暴露 leffa_predict_vt API，但本轮三次提交均立即返回 service error，不能当作稳定免费容量。",
    status: "candidate-public-demo-unstable",
  },
  {
    id: "swifttry",
    kind: "self-hosted-video",
    name: "SwiftTry",
    url: "https://github.com/VinAIResearch/SwiftTry",
    license: "代码 BSD-3-Clause；模型派生自 SD-Turbo，须同时遵守底座模型许可证",
    use: "视频试衣候选，提供公开权重；不属于当前静态商品图首选链路。",
    gate: "需要 CUDA、多组模型权重与姿态依赖；模型权重不能只按代码许可证判断商用边界。",
    status: "candidate-video-license-review",
  },
  {
    id: "miragic-hf-demo",
    kind: "public-demo-external-service",
    name: "Miragic Virtual Try-On Hugging Face Space",
    url: "https://huggingface.co/spaces/Miragic-AI/Miragic-Virtual-Try-On",
    license: "未声明；核心逻辑经过混淆并调用外部服务",
    use: "公开 Space 暴露 virtual_tryon API，带 12 组人物和服装样例。",
    gate: "本轮公开样例任务取得 event id 后没有返回结果；无许可证和透明模型链路，不进入商用候选。",
    status: "public-demo-opaque-incomplete",
  },
  {
    id: "weshop-hf-demo",
    kind: "public-demo-external-service",
    name: "WeShopAI Virtual Try-On Hugging Face Space",
    url: "https://huggingface.co/spaces/WeShopAI/WeShopAI-Virtual-Try-On",
    license: "Hugging Face 模型卡为 other；后端调用 WeShopAI 外部任务服务",
    use: "公开 Space 暴露 generate_image API，可作人工效果对照。",
    gate: "Space 开启 Hugging Face OAuth，服务许可证与免费额度不透明；不作为可自动复跑或商用依赖。",
    status: "oauth-gated-opaque",
  },
  {
    id: "idm-vton",
    kind: "self-hosted",
